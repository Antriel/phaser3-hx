...
@:native("Phaser.GameObjects.Arc") extern class Arc extends Shape {
	...
	**/
	function setSize(width:Float, height:Float):Arc;
	/**
		Sets the display size of this Game Object.
		
		Calling this will adjust the scale.
	**/
	function setDisplaySize(width:Float, height:Float):Arc;
	/**
	...
	**/
	function setPipeline(pipelineName:String):Arc;
	/**
	...
	**/
	function setInteractive(?shape:Dynamic, ?callback:global.phaser.types.input.HitAreaCallback, ?dropZone:Bool):Arc;
	/**
