...
@:native("Phaser.GameObjects.Text") extern class Text extends GameObject {
	...
	**/
	function setPipeline(pipelineName:String):Text;
	/**
	...
	**/
	function setInteractive(?shape:Dynamic, ?callback:global.phaser.types.input.HitAreaCallback, ?dropZone:Bool):Text;
	/**
	...
	**/
	static function GetTextSize(text:Text, size:global.phaser.types.gameobjects.text.TextMetrics, lines:Array<Dynamic>):Dynamic;
	/**
		Calculates the ascent, descent and fontSize of a given font style.
	**/
	static function MeasureText(textStyle:TextStyle):global.phaser.types.gameobjects.text.TextMetrics;
}