...
@:native("Phaser.GameObjects.Star") extern class Star extends Shape {
	...
	**/
	function setSize(width:Float, height:Float):Star;
	/**
		Sets the display size of this Game Object.
		
		Calling this will adjust the scale.
	**/
	function setDisplaySize(width:Float, height:Float):Star;
	/**
	...
	**/
	function setPipeline(pipelineName:String):Star;
	/**
	...
	**/
	function setInteractive(?shape:Dynamic, ?callback:global.phaser.types.input.HitAreaCallback, ?dropZone:Bool):Star;
	/**
