...
**/
@:native("Phaser.GameObjects.Image") extern class Image extends GameObject {
	...
	**/
	function setAlpha(?topLeft:Float, ?topRight:Float, ?bottomLeft:Float, ?bottomRight:Float):Image;
	/**
	...
	**/
	...
	/**
		...
		* ERASE (only works when rendering to a framebuffer, like a Render Texture)
		...
		are used.
	**/
	function setBlendMode(value:ts.AnyOf2<String, global.phaser.BlendModes>):Image;
	/**
	...
	**/
	...
	/**
		...
		Setting the depth will queue a depth sort event within the Scene.
	**/
	function setDepth(value:Float):Image;
	/**
	...
	**/
	...
	/**
		...
		If this Game Object has a physics body, it will not change the body. This is a rendering toggle only.
	**/
	function toggleFlipX():Image;
	/**
		Toggles the vertical flipped state of this Game Object.
	**/
	function toggleFlipY():Image;
	/**
		...
		If this Game Object has a physics body, it will not change the body. This is a rendering toggle only.
	**/
	function setFlipX(value:Bool):Image;
	/**
		Sets the vertical flipped state of this Game Object.
	**/
	function setFlipY(value:Bool):Image;
	/**
		...
		If this Game Object has a physics body, it will not change the body. This is a rendering toggle only.
	**/
	function setFlip(x:Bool, y:Bool):Image;
	/**
		Resets the horizontal and vertical flipped state of this Game Object back to their default un-flipped state.
	**/
	function resetFlip():Image;
	/**
	...
	**/
	function setMask(mask:ts.AnyOf2<global.phaser.display.masks.BitmapMask, global.phaser.display.masks.GeometryMask>):Image;
	/**
		Clears the mask that this Game Object was using.
	**/
	function clearMask(?destroyMask:Bool):Image;
	/**
	...
	**/
	function setOrigin(?x:Float, ?y:Float):Image;
	/**
		Sets the origin of this Game Object based on the Pivot values in its Frame.
	**/
	function setOriginFromFrame():Image;
	/**
		Sets the display origin of this Game Object.
		The difference between this and setting the origin is that you can use pixel values for setting the display origin.
	**/
	function setDisplayOrigin(?x:Float, ?y:Float):Image;
	/**
		Updates the Display Origin cached values internally stored on this Game Object.
		You don't usually call this directly, but it is exposed for edge-cases where you may.
	**/
	function updateDisplayOrigin():Image;
	/**
	...
	**/
	function setPipeline(pipeline:ts.AnyOf2<String, global.phaser.renderer.webgl.WebGLPipeline>, ?pipelineData:Dynamic, ?copyData:Bool):Image;
	/**
	...
	**/
	function setPostPipeline(pipelines:ts.AnyOf6<String, haxe.Constraints.Function, Array<haxe.Constraints.Function>, Array<String>, global.phaser.renderer.webgl.pipelines.PostFXPipeline, Array<global.phaser.renderer.webgl.pipelines.PostFXPipeline>>, ?pipelineData:Dynamic, ?copyData:Bool):Image;
	/**
		...
		Both the pipeline and post pipelines share the pipeline data object together.
	**/
	function setPipelineData(key:String, ?value:Dynamic):Image;
	/**
	...
	**/
	function removePostPipeline(pipeline:ts.AnyOf2<String, global.phaser.renderer.webgl.pipelines.PostFXPipeline>):Image;
	/**
	...
	**/
	...
	/**
		...
		them from physics bodies if not accounted for in your code.
	**/
	function setScrollFactor(x:Float, ?y:Float):Image;
	/**
	...
	**/
	function setSizeToFrame(frame:global.phaser.textures.Frame):Image;
	/**
		...
		size of the hit area. To do this you should adjust the `input.hitArea` object directly.
	**/
	function setSize(width:Float, height:Float):Image;
	/**
		Sets the display size of this Game Object.
		
		Calling this will adjust the scale.
	**/
	function setDisplaySize(width:Float, height:Float):Image;
	/**
	...
	**/
	function setCrop(?x:ts.AnyOf2<Float, global.phaser.geom.Rectangle>, ?y:Float, ?width:Float, ?height:Float):Image;
	/**
		Sets the texture and frame this Game Object will use to render with.
		
		Textures are referenced by their string-based keys, as stored in the Texture Manager.
	**/
	function setTexture(key:String, ?frame:ts.AnyOf2<String, Float>):Image;
	/**
	...
	**/
	function setFrame(frame:ts.AnyOf2<String, Float>, ?updateSize:Bool, ?updateOrigin:Bool):Image;
	/**
	...
	**/
	function setTint(?topLeft:Float, ?topRight:Float, ?bottomLeft:Float, ?bottomRight:Float):Image;
	/**
	...
	**/
	function setTintFill(?topLeft:Float, ?topRight:Float, ?bottomLeft:Float, ?bottomRight:Float):Image;
	/**
	...
	**/
	function setPosition(?x:Float, ?y:Float, ?z:Float, ?w:Float):Image;
	/**
		Copies an object's coordinates to this Game Object's position.
	**/
	function copyPosition(source:ts.AnyOf3<global.phaser.types.math.Vector2Like, global.phaser.types.math.Vector3Like, global.phaser.types.math.Vector4Like>):Image;
	/**
	...
	**/
	function setRandomPosition(?x:Float, ?y:Float, ?width:Float, ?height:Float):Image;
	/**
		Sets the rotation of this Game Object.
	**/
	function setRotation(?radians:Float):Image;
	/**
		Sets the angle of this Game Object.
	**/
	function setAngle(?degrees:Float):Image;
	/**
		Sets the scale of this Game Object.
	**/
	function setScale(x:Float, ?y:Float):Image;
	/**
		Sets the x position of this Game Object.
	**/
	function setX(?value:Float):Image;
	/**
		Sets the y position of this Game Object.
	**/
	function setY(?value:Float):Image;
	/**
	...
	**/
	function setZ(?value:Float):Image;
	/**
		Sets the w position of this Game Object.
	**/
	function setW(?value:Float):Image;
	/**
	...
	**/
	...
	/**
		...
		An invisible Game Object will skip rendering, but will still process update logic.
	**/
	function setVisible(value:Bool):Image;
	/**
