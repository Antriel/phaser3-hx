...
@:native("Phaser.GameObjects.Grid") extern class Grid extends Shape {
	...
	**/
	function setSize(width:Float, height:Float):Grid;
	/**
	...
	**/
	function setPipeline(pipelineName:String):Grid;
	/**
	...
	**/
	function setInteractive(?shape:Dynamic, ?callback:global.phaser.types.input.HitAreaCallback, ?dropZone:Bool):Grid;
	/**
