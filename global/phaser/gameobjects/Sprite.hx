...
**/
@:native("Phaser.GameObjects.Sprite") extern class Sprite extends GameObject {
	...
	**/
	function setAlpha(?topLeft:Float, ?topRight:Float, ?bottomLeft:Float, ?bottomRight:Float):Sprite;
	/**
	...
	**/
	...
	/**
		...
		* ERASE (only works when rendering to a framebuffer, like a Render Texture)
		...
		are used.
	**/
	function setBlendMode(value:ts.AnyOf2<String, global.phaser.BlendModes>):Sprite;
	/**
	...
	**/
	...
	/**
		...
		Setting the depth will queue a depth sort event within the Scene.
	**/
	function setDepth(value:Float):Sprite;
	/**
	...
	**/
	...
	/**
		...
		If this Game Object has a physics body, it will not change the body. This is a rendering toggle only.
	**/
	function toggleFlipX():Sprite;
	/**
		Toggles the vertical flipped state of this Game Object.
	**/
	function toggleFlipY():Sprite;
	/**
		...
		If this Game Object has a physics body, it will not change the body. This is a rendering toggle only.
	**/
	function setFlipX(value:Bool):Sprite;
	/**
		Sets the vertical flipped state of this Game Object.
	**/
	function setFlipY(value:Bool):Sprite;
	/**
		...
		If this Game Object has a physics body, it will not change the body. This is a rendering toggle only.
	**/
	function setFlip(x:Bool, y:Bool):Sprite;
	/**
		Resets the horizontal and vertical flipped state of this Game Object back to their default un-flipped state.
	**/
	function resetFlip():Sprite;
	/**
	...
	**/
	function setMask(mask:ts.AnyOf2<global.phaser.display.masks.BitmapMask, global.phaser.display.masks.GeometryMask>):Sprite;
	/**
		Clears the mask that this Game Object was using.
	**/
	function clearMask(?destroyMask:Bool):Sprite;
	/**
	...
	**/
	function setOrigin(?x:Float, ?y:Float):Sprite;
	/**
		Sets the origin of this Game Object based on the Pivot values in its Frame.
	**/
	function setOriginFromFrame():Sprite;
	/**
		Sets the display origin of this Game Object.
		The difference between this and setting the origin is that you can use pixel values for setting the display origin.
	**/
	function setDisplayOrigin(?x:Float, ?y:Float):Sprite;
	/**
		Updates the Display Origin cached values internally stored on this Game Object.
		You don't usually call this directly, but it is exposed for edge-cases where you may.
	**/
	function updateDisplayOrigin():Sprite;
	/**
	...
	**/
	function setPipeline(pipelineName:String):Sprite;
	/**
	...
	**/
	...
	/**
		...
		them from physics bodies if not accounted for in your code.
	**/
	function setScrollFactor(x:Float, ?y:Float):Sprite;
	/**
	...
	**/
	function setSizeToFrame(frame:global.phaser.textures.Frame):Sprite;
	/**
		...
		size of the hit area. To do this you should adjust the `input.hitArea` object directly.
	**/
	function setSize(width:Float, height:Float):Sprite;
	/**
		Sets the display size of this Game Object.
		
		Calling this will adjust the scale.
	**/
	function setDisplaySize(width:Float, height:Float):Sprite;
	/**
	...
	**/
	function setCrop(?x:ts.AnyOf2<Float, global.phaser.geom.Rectangle>, ?y:Float, ?width:Float, ?height:Float):Sprite;
	/**
		Sets the texture and frame this Game Object will use to render with.
		
		Textures are referenced by their string-based keys, as stored in the Texture Manager.
	**/
	function setTexture(key:String, ?frame:ts.AnyOf2<String, Float>):Sprite;
	/**
	...
	**/
	function setFrame(frame:ts.AnyOf2<String, Float>, ?updateSize:Bool, ?updateOrigin:Bool):Sprite;
	/**
		Fill or additive?
	**/
	var tintFill : Bool;
	...
	**/
	function setTint(?topLeft:Float, ?topRight:Float, ?bottomLeft:Float, ?bottomRight:Float):Sprite;
	/**
	...
	**/
	function setTintFill(?topLeft:Float, ?topRight:Float, ?bottomLeft:Float, ?bottomRight:Float):Sprite;
	/**
	...
	**/
	function setPosition(?x:Float, ?y:Float, ?z:Float, ?w:Float):Sprite;
	/**
	...
	**/
	function setRandomPosition(?x:Float, ?y:Float, ?width:Float, ?height:Float):Sprite;
	/**
		Sets the rotation of this Game Object.
	**/
	function setRotation(?radians:Float):Sprite;
	/**
		Sets the angle of this Game Object.
	**/
	function setAngle(?degrees:Float):Sprite;
	/**
		Sets the scale of this Game Object.
	**/
	function setScale(x:Float, ?y:Float):Sprite;
	/**
		Sets the x position of this Game Object.
	**/
	function setX(?value:Float):Sprite;
	/**
		Sets the y position of this Game Object.
	**/
	function setY(?value:Float):Sprite;
	/**
	...
	**/
	function setZ(?value:Float):Sprite;
	/**
		Sets the w position of this Game Object.
	**/
	function setW(?value:Float):Sprite;
	/**
	...
	**/
	...
	/**
		...
		An invisible Game Object will skip rendering, but will still process update logic.
	**/
	function setVisible(value:Bool):Sprite;
	/**
