...
@:native("Phaser.Input.Keyboard.Events") @valueModuleOnly extern class Events {
	/**
	...
	**/
	static final ANY_KEY_DOWN : Dynamic;
	/**
	...
	**/
	static final ANY_KEY_UP : Dynamic;
	/**
		...
		```
	**/
	static final COMBO_MATCH : Dynamic;
	/**
		The Key Down Event.
