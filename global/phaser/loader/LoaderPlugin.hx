...
@:native("Phaser.Loader.LoaderPlugin") extern class LoaderPlugin extends global.phaser.events.EventEmitter {
	...
	**/
	...
	/**
		...
		It is available in the default build but can be excluded from custom builds.
	**/
	function audio(key:ts.AnyOf3<String, global.phaser.types.loader.filetypes.AudioFileConfig, Array<global.phaser.types.loader.filetypes.AudioFileConfig>>, ?urls:ts.AnyOf2<String, Array<String>>, ?config:Dynamic, ?xhrSettings:global.phaser.types.loader.XHRSettingsObject):LoaderPlugin;
	/**
		...
		It is available in the default build but can be excluded from custom builds.
	**/
	function audioSprite(key:ts.AnyOf3<String, global.phaser.types.loader.filetypes.AudioSpriteFileConfig, Array<global.phaser.types.loader.filetypes.AudioSpriteFileConfig>>, jsonURL:String, ?audioURL:ts.AnyOf2<String, Array<String>>, ?audioConfig:Dynamic, ?audioXhrSettings:global.phaser.types.loader.XHRSettingsObject, ?jsonXhrSettings:global.phaser.types.loader.XHRSettingsObject):LoaderPlugin;
	/**
		...
		It is available in the default build but can be excluded from custom builds.
	**/
	function binary(key:ts.AnyOf3<String, global.phaser.types.loader.filetypes.BinaryFileConfig, Array<global.phaser.types.loader.filetypes.BinaryFileConfig>>, ?url:String, ?dataType:Dynamic, ?xhrSettings:global.phaser.types.loader.XHRSettingsObject):LoaderPlugin;
	/**
	...
	**/
	...
	/**
		...
		It is available in the default build but can be excluded from custom builds.
	**/
	function css(key:ts.AnyOf3<String, global.phaser.types.loader.filetypes.CSSFileConfig, Array<global.phaser.types.loader.filetypes.CSSFileConfig>>, ?url:String, ?xhrSettings:global.phaser.types.loader.XHRSettingsObject):LoaderPlugin;
	/**
		...
		It is available in the default build but can be excluded from custom builds.
	**/
	function glsl(key:ts.AnyOf3<String, global.phaser.types.loader.filetypes.GLSLFileConfig, Array<global.phaser.types.loader.filetypes.GLSLFileConfig>>, ?url:String, ?shaderType:String, ?xhrSettings:global.phaser.types.loader.XHRSettingsObject):LoaderPlugin;
	/**
		...
		It is available in the default build but can be excluded from custom builds.
	**/
	function html(key:ts.AnyOf3<String, global.phaser.types.loader.filetypes.HTMLFileConfig, Array<global.phaser.types.loader.filetypes.HTMLFileConfig>>, ?url:String, ?xhrSettings:global.phaser.types.loader.XHRSettingsObject):LoaderPlugin;
	/**
		...
		It is available in the default build but can be excluded from custom builds.
	**/
	function htmlTexture(key:ts.AnyOf3<String, global.phaser.types.loader.filetypes.HTMLTextureFileConfig, Array<global.phaser.types.loader.filetypes.HTMLTextureFileConfig>>, ?url:String, ?width:Float, ?height:Float, ?xhrSettings:global.phaser.types.loader.XHRSettingsObject):LoaderPlugin;
	/**
		...
		It is available in the default build but can be excluded from custom builds.
	**/
	function image(key:ts.AnyOf3<String, global.phaser.types.loader.filetypes.ImageFileConfig, Array<global.phaser.types.loader.filetypes.ImageFileConfig>>, ?url:ts.AnyOf2<String, Array<String>>, ?xhrSettings:global.phaser.types.loader.XHRSettingsObject):LoaderPlugin;
	/**
		...
		It is available in the default build but can be excluded from custom builds.
	**/
	function json(key:ts.AnyOf3<String, global.phaser.types.loader.filetypes.JSONFileConfig, Array<global.phaser.types.loader.filetypes.JSONFileConfig>>, ?url:ts.AnyOf2<String, Dynamic>, ?dataKey:String, ?xhrSettings:global.phaser.types.loader.XHRSettingsObject):LoaderPlugin;
	/**
		...
		It is available in the default build but can be excluded from custom builds.
	**/
	function multiatlas(key:ts.AnyOf3<String, global.phaser.types.loader.filetypes.MultiAtlasFileConfig, Array<global.phaser.types.loader.filetypes.MultiAtlasFileConfig>>, ?atlasURL:String, ?path:String, ?baseURL:String, ?atlasXhrSettings:global.phaser.types.loader.XHRSettingsObject):LoaderPlugin;
	/**
	...
	**/
	...
	/**
		...
		It is available in the default build but can be excluded from custom builds.
	**/
	function pack(key:ts.AnyOf3<String, global.phaser.types.loader.filetypes.PackFileConfig, Array<global.phaser.types.loader.filetypes.PackFileConfig>>, ?url:String, ?dataKey:String, ?xhrSettings:global.phaser.types.loader.XHRSettingsObject):LoaderPlugin;
	/**
	...
	**/
	...
	/**
		...
		It is available in the default build but can be excluded from custom builds.
	**/
	function sceneFile(key:ts.AnyOf3<String, global.phaser.types.loader.filetypes.SceneFileConfig, Array<global.phaser.types.loader.filetypes.SceneFileConfig>>, ?url:String, ?xhrSettings:global.phaser.types.loader.XHRSettingsObject):LoaderPlugin;
	/**
		...
		It is available in the default build but can be excluded from custom builds.
	**/
	function scenePlugin(key:ts.AnyOf3<String, global.phaser.types.loader.filetypes.ScenePluginFileConfig, Array<global.phaser.types.loader.filetypes.ScenePluginFileConfig>>, ?url:ts.AnyOf2<String, haxe.Constraints.Function>, ?systemKey:String, ?sceneKey:String, ?xhrSettings:global.phaser.types.loader.XHRSettingsObject):LoaderPlugin;
	/**
		...
		It is available in the default build but can be excluded from custom builds.
	**/
	function script(key:ts.AnyOf3<String, global.phaser.types.loader.filetypes.ScriptFileConfig, Array<global.phaser.types.loader.filetypes.ScriptFileConfig>>, ?url:String, ?xhrSettings:global.phaser.types.loader.XHRSettingsObject):LoaderPlugin;
	/**
	...
	**/
	...
	/**
		...
		It is available in the default build but can be excluded from custom builds.
	**/
	function text(key:ts.AnyOf3<String, global.phaser.types.loader.filetypes.TextFileConfig, Array<global.phaser.types.loader.filetypes.TextFileConfig>>, ?url:String, ?xhrSettings:global.phaser.types.loader.XHRSettingsObject):LoaderPlugin;
	/**
		...
		It is available in the default build but can be excluded from custom builds.
	**/
	function tilemapCSV(key:ts.AnyOf3<String, global.phaser.types.loader.filetypes.TilemapCSVFileConfig, Array<global.phaser.types.loader.filetypes.TilemapCSVFileConfig>>, ?url:String, ?xhrSettings:global.phaser.types.loader.XHRSettingsObject):LoaderPlugin;
	/**
		...
		It is available in the default build but can be excluded from custom builds.
	**/
	function tilemapImpact(key:ts.AnyOf3<String, global.phaser.types.loader.filetypes.TilemapImpactFileConfig, Array<global.phaser.types.loader.filetypes.TilemapImpactFileConfig>>, ?url:String, ?xhrSettings:global.phaser.types.loader.XHRSettingsObject):LoaderPlugin;
	/**
		...
		It is available in the default build but can be excluded from custom builds.
	**/
	function tilemapTiledJSON(key:ts.AnyOf3<String, global.phaser.types.loader.filetypes.TilemapJSONFileConfig, Array<global.phaser.types.loader.filetypes.TilemapJSONFileConfig>>, ?url:ts.AnyOf2<String, Dynamic>, ?xhrSettings:global.phaser.types.loader.XHRSettingsObject):LoaderPlugin;
	/**
	...
	**/
	...
	/**
		...
		It is available in the default build but can be excluded from custom builds.
	**/
	function video(key:ts.AnyOf3<String, global.phaser.types.loader.filetypes.VideoFileConfig, Array<global.phaser.types.loader.filetypes.VideoFileConfig>>, ?urls:ts.AnyOf2<String, Array<String>>, ?loadEvent:String, ?asBlob:Bool, ?noAudio:Bool, ?xhrSettings:global.phaser.types.loader.XHRSettingsObject):LoaderPlugin;
	/**
